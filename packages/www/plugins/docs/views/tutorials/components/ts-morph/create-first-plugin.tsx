...
export default function CreateFirstPlugin() {
  return (
    <section id="5-creating-your-first-plugin">
      <H1>5. Creating Your First Plugin</H1>
      <P>
        Creating your first plugin with <C>ts-morph</C> involves understanding the complete workflow from schema processing to code generation. This comprehensive example demonstrates building a TypeScript interface generator that transforms JSON schemas into properly typed interfaces with full feature support.
      </P>
      <P>
        Let's create a plugin that generates TypeScript interfaces from JSON schema definitions. This will demonstrate the core concepts of using <C>ts-morph</C> for code generation.
      </P>

      <H2>5.1. Define the Plugin Interface</H2>
      <P>
      ...
      <P>First, let's define the types for our plugin:</P>
      <Code copy language="typescript" className="bg-black text-white px-mx-10 px-mb-20">{examples[0]}</Code>

      <H2>5.2. Core Plugin Implementation</H2>
      <P>
      ...
      <Code copy language="typescript" className="bg-black text-white px-mx-10 px-mb-20">{examples[1]}</Code>

      <H2>5.3. Plugin Entry Point</H2>
      <P>
      ...
      <Code copy language="typescript" className="bg-black text-white px-mx-10 px-mb-20">{examples[2]}</Code>

      <H2>5.4. Example Usage</H2>
      <P>
      ...
      <P>Create an example schema file:</P>
      <Code copy language="json" className="bg-black text-white px-mx-10 px-mb-20">{examples[3]}</Code>
      <P>Run the plugin:</P>
      <Code copy language="bash" className="bg-black text-white px-mx-10 px-mb-20">{examples[4]}</Code>
      <P>Generated output:</P>
      <Code copy language="typescript" className="bg-black text-white px-mx-10 px-mb-20">{examples[5]}</Code>
    </section>
  )
}
