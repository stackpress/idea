import { H1, H2, H3, P } from '../../../../components/index.js'
...
export default function Troubleshooting() {
  return (
    <section id="9-troubleshooting">
      ...
      <H3>9.1.1. Invalid TypeScript Syntax</H3>
      <P>
      ...
      <H3>9.1.3. Memory Issues with Large Schemas</H3>
      <P>
      ...
      <H3>9.2.2. Save Intermediate Results</H3>
      <P>
      ...
      <H3>9.2.3. Validate Each Step</H3>
      <P>
      ...
      <Code copy language='typescript' className="bg-black text-white">{examples[5]}</Code>
    </section>
  )
}
