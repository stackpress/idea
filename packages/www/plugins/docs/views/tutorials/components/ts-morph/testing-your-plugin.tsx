...
import { H1, P, C, B } from '../../../../components/index.js'
...
export default function TestingYourPlugin() {
  return (
    <section id="7-testing-your-plugin">
      <H1>7. Testing Your Plugin</H1>
      <P>
      ...
      <Code copy language='bash' className="bg-black text-white">{examples[1]}</Code>
    </section>
  )
}
