...
export function Body() {
  ...
  return (
    <main className="px-h-100-0 overflow-auto px-p-10">
      ...
      <P>
        This tutorial demonstrates how to create a plugin that generates GraphQL type definitions from <C>.idea</C> schema files. The plugin will transform your schema models, types, and enums into proper GraphQL schema definitions.
      </P>
      ...
      <section id="1-overview">
        ...
        <ul className="list-disc pl-6 my-4">
          <li className="my-2"><strong>Types</strong>: GraphQL object types from schema models</li>
          <li className="my-2"><strong>Inputs</strong>: GraphQL input types for mutations</li>
          <li className="my-2"><strong>Enums</strong>: GraphQL enum types from schema enums</li>
          <li className="my-2"><strong>Scalars</strong>: Custom scalar types when needed</li>
          <li className="my-2"><strong>Queries and Mutations</strong>: Basic CRUD operations</li>
        </ul>
      </section>
      ...
      <section id="conclusion">
        <P>
          This tutorial provides a comprehensive foundation for creating GraphQL schema generators from <C>.idea</C> files. The generated schemas can be used with any GraphQL server implementation like Apollo Server, GraphQL Yoga, or others.
        </P>
      </section>

      <Nav
        prev={{ text: 'Markdown Documentation Plugin', href: '/docs/tutorials/markdown-documentation-plugin' }}
        next={{ text: 'TypeScript Interface Plugin', href: '/docs/tutorials/typescript-interface-plugin' }}
      />
    </main>
  );
}
