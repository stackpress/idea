    ...
    <header className="theme-bg-bg1 theme-bc-bd0 duration-200 absolute px-h-60 px-l-0 px-r-0 px-t-0 border-b">
      <div className="flex align-middle items-center px-px-20 px-h-100-0">
        <a className="theme-tx1 flex items-center no-underline px-mr-10" href="/">
          <img src="/icon.png" alt="idea-logo" className='px-w-30 px-h-30 px-mr-10' />
          <span className="px-fs-20 font-extrabold">idea</span>
        </a>
        <nav className="flex-grow">
          <a className="theme-tx1 flex items-center no-underline uppercase mt-1 hover:text-yellow-500" href="/docs/introduction">
            {_('Docs')}
          </a>
        </nav>
        <nav className="rmd-hidden flex items-center">
          <a href="https://marketplace.visualstudio.com/items?itemName=stackpress.idea-schema" className="px-mr-10 hover:text-yellow-500 theme-tx1">
