...
- follow the [Getting Started](https://github.com/stackpress/idea/blob/main/specs/getting-started.md)

If you are learning the format:

- read [The `.idea` File](https://github.com/stackpress/idea/blob/main/specs/concepts/the-idea-file.md)
- read [Schema Building](https://github.com/stackpress/idea/blob/main/specs/concepts/schema-building.md)

If you are building with it:

- read [Run a Schema](https://github.com/stackpress/idea/blob/main/specs/how-to/run-a-schema.md)
- read [Write a Plugin](https://github.com/stackpress/idea/blob/main/specs/how-to/write-a-plugin.md)
